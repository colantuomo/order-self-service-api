...
export class OrderRepository implements IRepository<Order | Order[]>{
	...
	async read(...args: unknown[]): PromiseResponse<Order | Order[]> {
	...
	update(id: string, item: Order | Order[]): PromiseResponse<Order | Order[]> {
		throw new Error("Method not implemented.");
	}

	updateItem(id: string, item: OrderItem | OrderItem[]): PromiseResponse<OrderItem | OrderItem[]>{
		throw new Error("Method not implemented.");
	}
/*
	updateStatus(id: string, item: Order): PromiseResponse<Order>{
